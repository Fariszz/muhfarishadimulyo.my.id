...
description: "Memahami perbedaan mendasar antara operator `==` dan metode `equals()` di Java."
pubDate: "2025-1-13"
tags: ["java", "programming"]
url: "https://muhfarishadimulyo.my.id/blog/java-equals-operator/"
type: article
---
...
Ketika Anda membuat objek String menggunakan new String("test"), Anda menciptakan instance baru dari kelas String dengan alokasi memori terpisah. Variabel yang Anda buat hanya menyimpan referensi ke objek tersebut, bukan nilai langsung.
